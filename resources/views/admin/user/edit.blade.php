...
<body class="p-6">
    ...
    <div class="floating" style="position: absolute; top: 10%; left: 5%;">
        <i class="fas fa-user-edit text-pink-300 text-4xl"></i>
    </div>
    ...
    <div class="max-w-4xl mx-auto fade-in">
        ...
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.user.index') }}" class="btn-secondary px-4 py-3 flex items-center mr-4">
                    <i class="fas fa-arrow-left mr-2"></i> Kembali
                </a>
                <div class="w-14 h-14 bg-white rounded-full flex items-center justify-center pulse-animation shadow-lg">
                    <i class="fas fa-user-edit text-pink-600 text-2xl"></i>
                </div>
                <div>
                    <h1 class="text-3xl font-bold text-pink-800">Edit User</h1>
            ...
            <div class="flex items-center space-x-2">
                ...
                @endif
                <span class="text-sm text-pink-700">ID: {{ $user->id }}</span>
            </div>
        </div>
        ...
        <div class="form-container overflow-hidden">
            ...
            <div class="form-header text-white p-8 text-center">
                ...
                <h1 class="text-3xl font-bold">Edit Data User</h1>
                <p class="text-pink-100 mt-2 text-lg">Perbarui informasi user {{ $user->name }}</p>
            </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mt-4">
                            <label class="block text-gray-700 font-medium mb-3 flex items-center">
                                ...
                                Password
                                <span class="text-sm text-gray-500 ml-2">(kosongkan jika tidak ingin mengubah)</span>
                            </label>
                            <input type="password" name="password" 
                                   class="w-full form-input p-4"
                        ...
                        <div class="mb-2">
                            ...
                            <select name="role" class="w-full form-input p-4">
                                <option value="user" @selected($user->role == 'user')>
                                    <span class="user-badge">User</span> - Akses standar untuk pemesanan tiket
                                </option>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-yellow-700 text-sm mt-1">
                                        Mengubah role ke "Admin" akan memberikan akses penuh ke sistem administrasi.
                                        Pastikan perubahan ini memang diperlukan.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6 slide-in">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-blue-800 text-xl mb-2">Tips Mengedit User</h3>
                    <ul class="text-blue-700 list-disc list-inside space-y-2">
                        <li>Pastikan username dan email unik dalam sistem</li>
                        ...
                        <li>Data yang diupdate akan langsung tersimpan di sistem</li>
                    </ul>
                </div>
            </div>
        </div>
